...
def test_more_media_functions(tmp_path):
    ...
    ffmpeg.sample(src,tmp_path/'sample.mp4',1)
    ...
    for p in [tmp_path/'trim.mkv',tmp_path/'out.mp4',tmp_path/'out2.mkv',tmp_path/'sample.mp4',tmp_path/'bass.m4a',tmp_path/'opt.mkv']:
